    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Text('Preparation', style: AppTextStyles.section(context)),
          const SizedBox(height: 8),
          Text(test.preparation, style: AppTextStyles.body(context)),
          const SizedBox(height: AppSpacing.lg),
          Text('Included Parameters', style: AppTextStyles.section(context)),
          ...test.parameters.map(
            (p) => ListTile(
